...
inline std::string ToString(MarketDataType type) 
{
    switch (type) {
        ...
        case MarketDataType::L1Update:         return "L1Update";
        case MarketDataType::L2Update:         return "L2Update";
        case MarketDataType::Custom:           return "Custom";
        case MarketDataType::CustomMultiple:   return "CustomMultiple";
    }
...
struct MDTrade : public MarketDataUpdate
{
    ...
    std::string ToString() const 
    {
        ...
        oss << "MDTrade { "
            ...
            << ", Price=" << Price
            << ", Qty="   << Qty
            << ", AggressorSide=" << ::ToString(AggressorSide)
